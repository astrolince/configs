...
`$ sudo pacman -S --needed android-tools flatpak snapd git tree vim base-devel curl gawk gzip p7zip gnupg kgpg cronie wget aria2 dnscrypt-proxy tor torbrowser-launcher steam brave gimp audacity libreoffice-fresh exa gamemode neofetch nano gparted zsh ffsend ruby python golang`
